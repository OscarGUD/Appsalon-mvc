...
class LoginController {
        ...
        if($_SERVER['REQUEST_METHOD'] === 'POST'){
            ...
            if(empty($alertas)){
                ...
                if($usuario && $usuario->confirmado === '1'){
                    ...
                    $alertas = Usuario::setAlerta('error', 'El usuario no exite o no esta confirmado');
                }
    ...
    public static function confirmar(Router $router){
        ...
        if(empty($usuario)){
            ...
            $usuario->token = "";
            $usuario->guardar();
            $alertas = Usuario::setAlerta('exito', 'Cuenta comprobada correctamente');
        }
        //Obtener alertas
        $alertas = Usuario::getAlertas();
        // Renderisar la visa
